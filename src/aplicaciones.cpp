...
void aplicaciones::menu()
{
	...
	cout<<"\t\t\t------------------------------------"<<endl;
	cout<<"\t\t\t|  SISTEMA GESTION APLICACIONES    |"<<endl;
	cout<<"\t\t\t------------------------------------"<<endl;
...
void aplicaciones::insertar()
{
	...
	file.close();
	bitacora auditoria;
	auditoria.insertarAccion("7025", "INS APLICACION");
	system("pause");
}
void aplicaciones::desplegar()
{
	...
	file.close();
    bitacora auditoria;
    auditoria.insertarAccion("7026", "SEL APLICACION");
    system("pause");
}
void aplicaciones::modificar()
{
	...
	else
	{
        ...
        bitacora auditoria;
        auditoria.insertarAccion("7027", "UPD APLICACION");
	}
}
void aplicaciones::buscar()
{
	...
	else
	{
		...
		file.close();
        bitacora auditoria;
        auditoria.insertarAccion("7028", "SEA APLICACION");
	}
}
void aplicaciones::borrar()
{
	...
	else
	{
		...
		rename("temporal.txt","aplicaciones.txt");
        bitacora auditoria;
        auditoria.insertarAccion("7029", "DEL APLICACION");
	}
}
